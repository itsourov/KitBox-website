...
if ($_POST['intent']=="privacy") {
    echo "<div class='container featurebox'>
    <textarea rows='16' id='copy_textarea' name='TA1' spellcheck='false' >";
    echo "<h1>Privacy Policy for $name</h1>
  ...
  <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in $name. This policy is not applicable to any information collected offline or via channels other than this website.
